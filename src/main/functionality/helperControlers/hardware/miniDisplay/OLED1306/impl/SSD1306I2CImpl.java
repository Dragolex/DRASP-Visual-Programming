package main.functionality.helperControlers.hardware.miniDisplay.OLED1306.impl;
...
import main.functionality.helperControlers.hardware.miniDisplay.OLED1306.Command;
import main.functionality.helperControlers.hardware.miniDisplay.OLED1306.Constant;
import main.functionality.helperControlers.hardware.miniDisplay.OLED1306.SSD1306;
...
public class SSD1306I2CImpl extends SSD1306 {
	 ...
	 */
	public SSD1306I2CImpl(int width, int height, GpioPinDigitalOutput rstPin, int bus, int address) {
		super(width, height);
