...
public class RaspRC522 {
    ...
    public RaspRC522(int Speed, int PinReset) {
        ...
        if (Speed < 500000 || Speed > 32000000) {
            ...
            this.Speed = Speed;
            System.out.println(" --> OK Speed and go RC522_Init()");
        }
 //       RC522_Init();
    }
...
//        Gpio.digitalWrite(NRSTPD, Gpio.HIGH);
 ...
 /* 0000 0011*/
    ...
    /* back_data Length=16;,  back_data, backLen */
    ...
    /* Anti-collision detection.,Returns tuple of (error state, tag ID).,back_data-tagid */
